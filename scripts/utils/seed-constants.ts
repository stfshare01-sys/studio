...
export const SEED_EMPLOYEES: EmployeeSeedData[] = [
    // NIVEL 1: DIRECTOR (1)
    {
        ...
        hireDate: '2019-01-15', // ~7 years (6-10 range) -> Should be 22 days
    ...
    // NIVEL 2: GERENTE (1)
    {
        ...
        locationId: 'loc-corporativo-gdl',
        customShiftId: 'shift-oficina',
        hireDate: '2014-03-01', // ~12 years (11-15 range) -> Should be 24 days
        employmentType: 'permanent',
        shiftType: 'diurnal',
    ...
    // NIVEL 3: COORDINADORES (2)
    {
        ...
        locationId: 'loc-corporativo-gdl',
        customShiftId: 'shift-oficina',
        hireDate: '2021-06-15', // ~4 years (1-5 range) -> Should be 18 days
        employmentType: 'permanent',
        shiftType: 'diurnal',
    ...
    // NIVEL 4: EMPLEADOS RH (3)
    {
        ...
        locationId: 'loc-corporativo-gdl',
        customShiftId: 'shift-oficina',
        hireDate: '2024-02-01', // ~2 years (1-5 range) -> Should be 14 days
        employmentType: 'permanent',
        shiftType: 'diurnal',
    ...
    },
    {
        ...
        hireDate: '2008-03-15', // ~18 years (16-20 range) -> Should be 26 days
        employmentType: 'permanent',
        shiftType: 'mixed',
