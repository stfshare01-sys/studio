      ...
      <div className="flex flex-1 flex-col">
        ...
        <main className="flex-1 p-4 pt-0 sm:p-6 sm:pt-0">
          ...
          {!isLoading && masterLists?.length === 0 && (
            <EmptyState
              variant="folder"
              title="No hay listas maestras"
              description="Cree una nueva lista para empezar a gestionar datos reutilizables."
              actionLabel={canCreate ? "Nueva Lista" : undefined}
              onAction={canCreate ? () => window.location.href = '/master-lists/new' : undefined}
            />
          )}
        </main>
      </div>
