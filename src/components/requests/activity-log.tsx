...
import { FilePlus, MessageSquarePlus, UserCheck, CheckCircle2 } from "lucide-react";
...
const actionDetails: Record<AuditLogAction, { icon: React.ElementType, text: (log: AuditLog) => string }> = {
    ...
    STEP_ASSIGNEE_CHANGED: {
        icon: UserCheck,
        text: (log) => `${log.userFullName} asignó la tarea "${log.details.stepName}" a ${log.details.assigneeName}.`,
    },
    COMMENT_ADDED: {
